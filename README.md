...
All in all, I learned the hard way that making mistakes is inevitable and the best way to learn. It's crucial to consider practical limitations and to understand that while efficiency is important, it doesn't always guarantee the best outcome. I learned from my father that perfectionism is one of the sins in Jonathan Rowson’s book, The Seven Deadly Chess Sins: “Self-belief is not about thinking you will never go wrong, but rather knowing you can and will go wrong, but that these mistakes don’t define you.”
